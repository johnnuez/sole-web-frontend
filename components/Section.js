...
export default function Section({
  ...
  return (
    <div
      className={`flex flex-col mx-auto lg:bg-fixed bg-cover bg-center rounded-md overflow-hidden shadow-2xl bg-opacity-80 lg:bg-opacity-70 bg-zinc-800 max-w-[110rem] ${bgBlend}`}
      style={{
